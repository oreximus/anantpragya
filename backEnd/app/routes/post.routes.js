...
// Category Routes
console.log("post.routes.js for category routes");
router.post(
  "/create-category",
  verifyToken,
  verifyRoles(ROLES_LIST.Admin, ROLES_LIST.Editor),
  postSchema.createPostCategory,
...
router.put(
  ...
  verifyToken,
  verifyRoles(ROLES_LIST.Admin, ROLES_LIST.Editor),
  postSchema.updatePostCategory,
  postController.updatePostCategory
);
...
router.get(
  "/comments/:id",
  postSchema.getPostComments,
  postController.getPostComments
);
router.get(
  "/likes/:id",
  postSchema.getPostLikeCount,
  postController.getPostLikeCount
);
