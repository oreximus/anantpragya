          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="list-disc list-inside text-gray-600 text-lg leading-relaxed space-y-2">
                <li>गहराई से आध्यात्मिक ज्ञान प्राप्त करेंगे।</li>
                <li>जीवन के रहस्यों को समझेंगे और आंतरिक शांति पाएंगे।</li>
                <li>
                  अपनी छिपी हुई शक्तियों को पहचान कर एक संतुलित जीवन जी पाएंगे।
                </li>
                <li>पुस्तक खरीदकर बेहतर ज्ञान और दिशा प्राप्त करें।</li>
              </ul>
            </div>
            <div>
              {/* Book Image */}
              <div className="h-80 flex items-center justify-center p-4">
                <Link
                  href="https://www.amazon.in/dp/9355433891"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-auto h-auto rounded-2xl flex items-center justify-center shadow-lg overflow-hidden"
                >
                  <img
                    src="/book.png"
                    alt="शून्य से शिखर की ओर सेकंड हाफ - Book Cover"
                    className="w-full h-full object-contain rounded-2xl"
                  />
                </Link>
              </div>

              {/* Flipkart & Amazon Logos */}
              <div className="mt-12 flex justify-center items-center gap-6 flex-wrap">
                ...
                >
                  <img src="/amazon.png" alt="Amazon" className="h-10 w-auto" />
                </Link>

                <Link
                  href="https://www.flipkart.com/search?q=9355433891"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:scale-105 transition-transform"
                >
                  <img
                    src="/flipkart-512.webp"
                    alt="Flipkart"
