        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p
              ...
              style={{ fontFamily: "Noto Sans Devanagari, Arial, sans-serif" }}
            >
              समाज से जुड़े महत्वपूर्ण विषयों पर चर्चा और विचार साझा करें। बदलाव
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg">
              सामाजिक बदलाव को प्रेरित करने वाले विचार और लेख
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-red-600 to-orange-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-red-100 text-lg mb-8 leading-relaxed">
            सामाजिक बदलाव की दिशा में पहला कदम उठाएं, अपने विचार साझा करें और
            समाज को प्रेरित करें।
          </p>
